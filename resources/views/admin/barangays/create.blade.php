...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.barangay.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.barangays.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('barangay_name') ? 'is-invalid' : '' }}" type="text" name="barangay_name" id="barangay_name" value="{{ old('barangay_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('barangay_chairman') ? 'is-invalid' : '' }}" type="text" name="barangay_chairman" id="barangay_chairman" value="{{ old('barangay_chairman', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sk_chairman') ? 'is-invalid' : '' }}" type="text" name="sk_chairman" id="sk_chairman" value="{{ old('sk_chairman', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_no_of_voters') ? 'is-invalid' : '' }}" type="number" name="total_no_of_voters" id="total_no_of_voters" value="{{ old('total_no_of_voters', '') }}" step="1">
