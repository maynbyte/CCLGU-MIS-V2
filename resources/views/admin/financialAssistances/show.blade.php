                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <table class="table table-borderless mb-0">
                            <tbody>
                                <tr>
                                    <th style="width: 200px;"><i class="fas fa-hashtag text-muted"></i> {{ trans('cruds.financialAssistance.fields.id') }}</th>
                                    <td><span class="badge badge-secondary">{{ $financialAssistance->id }}</span></td>
                                </tr>
