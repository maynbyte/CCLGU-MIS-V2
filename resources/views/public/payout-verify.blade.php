...
<body class="hold-transition login-page">
    ...
    <style>
        ...
        /* Mobile: show top profile, hide grid elements */
        ...
        /* 2x2 Grid Layout for Tablet and Desktop */
        @media (min-width: 577px) {
            /* Hide mobile title and top profile */
            .title-mobile {
                display: none;
            }
            ...
            .title-right h2 {
                ...
                /* Ensure Beneficiary header uses labeled style with underline */
                .beneficiary-right h2 {
                    color: #0b5621;
                    border-bottom: 2px solid #0b5621;
                    padding-bottom: 0.5rem;
                ...
                /* Ensure Reference Number header uses labeled style with underline (when nested under .title-right) */
                .reference-right h2,
                .title-right .reference-right h2 {
                    color: #0b5621;
                    border-bottom: 2px solid #0b5621;
                    padding-bottom: 0.5rem;
                }

                /* Make payout highlight rows align and normalize padding so Where and When line up */
                .payout-highlight {
                    display: flex;
                    align-items: center;
                    background: #f8f9fa;
                ...
                /* Internal payout grid for Where / When inside full-width Payout Details */
                .payout-grid {
                    display: grid;
                    grid-template-columns: 1fr 1fr;
                    gap: 1rem;
            ...
            <div class="card-body login-card-body">
                ...
                <div class="header-logos mb-3">
                    ...
                    <div class="header-text">
                        ...
                        <div class="header-line">Province of Cavite</div>
                        <div class="header-line">Cavite City</div>
                        <div class="header-title">Financial Assistance Details</div>
                    </div>
                    <img src="{{ asset('chuacares.png') }}" alt="Chua Cares" class="logo-right">
                </div>

                <!-- Profile Picture -->
                <div class="text-center mb-3 profile-picture-wrapper">
                    @php
                    $photoUrl = null;
                    try {
                ...
                <div class="info-grid">
                    ...
                    <div class="info-section profile-section">
                        <div class="text-center profile-in-grid">
                            <img src="{{ $photoUrl ?: $defaultAvatar }}"
                                alt="Profile Picture"
                    ...
                    <!-- RIGHT COLUMN - Row 1: Financial Assistance Details + Reference Number -->
                    <div class="info-section title-right">
                        <div class="info-section reference-right" style="margin-bottom: 0 !important;">
                    ...
                    <!-- Beneficiary Information (left) -->
                    <div class="info-section beneficiary-right">
                    ...
                    <!-- Payout Details (full-width) with internal 2-column Where / When -->
                    <div class="info-section full-width payout-section">
                        <h2><i class="fas fa-calendar-check"></i> Payout Details</h2>

                        <div class="payout-grid">
                            <div class="payout-grid-item">
                        ...
                        <div class="mt-3" style="grid-column: 1 / -1;">
                            <div class="alert alert-success" style="font-size: 0.85rem; padding: 0.5rem;">
